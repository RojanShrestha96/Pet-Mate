    ...
    const fetchDashboardData = async () => {
      try {
        ...
        const shelterResponse = await fetch(
          "http://localhost:5000/api/shelter/me",
          {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 hidden sm:block">
                Welcome back, manage your shelter
              </p>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-secondary)] rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-white/80 text-sm mt-1">
                  ...
                  pending applications • {petStats.pendingReview} pets awaiting
                  review
                </p>
              </div>
                        ...
                        >
                          <Card className="p-4 hover:shadow-md transition-all group">
                            ...
                            <div className="flex items-center gap-2 pt-3 border-t border-gray-100">
                              <Link
                                to={`/shelter/applications/${app._id}`}
                                className="flex-1"
                              >
                                <Button
                                  variant="outline"
                        ...
                        <table className="w-full">
                          <thead className="bg-gray-50 border-b border-gray-200">
                            <tr>
                              ...
                              <th className="text-left py-3 px-4 text-xs font-semibold text-gray-500 uppercase hidden sm:table-cell">
                                Submitted
                              </th>
