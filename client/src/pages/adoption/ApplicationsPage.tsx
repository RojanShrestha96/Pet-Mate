...
const mockApplications: Application[] = [
  ...
  },
  {
    ...
    petSpecies: "cat",
    petImage:
      "https://images.unsplash.com/photo-1573865526739-10659fec78a5?w=100",
  ...
  },
  {
    ...
    petSpecies: "cat",
    petImage:
      "https://images.unsplash.com/photo-1495360010541-f48722b34f7d?w=100",
  ...
  },
  {
    ...
    petSpecies: "dog",
    petImage:
      "https://images.unsplash.com/photo-1586671267731-da2cf3ceeb80?w=100",
  ...
  },
  {
    ...
    petSpecies: "cat",
    petImage:
      "https://images.unsplash.com/photo-1592194996308-7b43878e84a6?w=100",
  ...
  const stats = useMemo(
    () => ({
      ...
      reviewing: mockApplications.filter((a) => a.status === "reviewing")
        .length,
      scheduled: mockApplications.filter((a) => a.status === "scheduled")
        .length,
