...
export function ApplicationDetailPage() {
  ...
  const application = {
    ...
    applicant: {
      ...
      reasonForAdoption:
        "Looking for a companion for outdoor activities and to complete our family.",
    ...
    timeline: [
      ...
      },
      {
        ...
        date: "2024-12-10T10:35:00",
        description: "4 documents attached",
        icon: "document",
      },
      {
        id: 3,
      ...
      },
      {
        ...
        description: "Proof of residence confirmed",
        icon: "verify",
      },
    ],
  ...
  const currentStepIndex = workflowSteps.findIndex(
    (s) => s.key === application.currentStep
  );
  ...
  const getNextAction = () => {
    switch (application.currentStep) {
      ...
      case "under-review":
        return "Documents verified, make decision";
      case "decision-pending":
        return "Approve or reject application";
      case "approved":
        return "Schedule meet & greet";
      case "meet-greet":
        return "Confirm adoption after meeting";
      case "accepted":
        return "Complete adoption paperwork";
      default:
  ...
  const handleApprove = () => {
    showToast(
      "Application approved! Moving to Meet & Greet scheduling. 🎉",
      "success"
    );
        ...
        <header className="bg-white border-b border-gray-200 sticky top-0 z-20 px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <NotificationCenter />
              {(application.currentStep === "under-review" ||
                application.currentStep === "decision-pending") && (
                <>
                  <Button
                    variant="outline"
                        ...
                        <div className="px-4 sm:px-5 pb-5 pt-0 space-y-6">
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                              <div>
                                ...
                                <p className="font-medium text-gray-900 text-sm">
                                  {application.applicant.homeType}
                                </p>
                              </div>
                              <div>
                                <p className="text-xs text-gray-500">
                                ...
                                <p className="font-medium text-gray-900 text-sm">
                                  {application.applicant.homeOwnership}
                                </p>
                              </div>
                              <div>
                                <p className="text-xs text-gray-500">
                                ...
                                <p className="font-medium text-gray-900 text-sm">
                                  {application.applicant.hasYard ? "Yes" : "No"}
                                </p>
                              </div>
                              <div>
                                <p className="text-xs text-gray-500">
                                ...
                                <p className="font-medium text-gray-900 text-sm">
                                  {application.applicant.existingPets || "None"}
                                </p>
                              </div>
                              <div>
                                <p className="text-xs text-gray-500">
                                ...
                                <p className="font-medium text-gray-900 text-sm">
                                  {application.applicant.hasChildren
                                    ? "Yes"
                                    : "No"}
                                </p>
                              </div>
                              <div>
                                ...
                                <p className="font-medium text-gray-900 text-sm">
                                  {application.applicant.workSchedule}
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="pt-4 border-t border-gray-100">
                            ...
                            <div>
                              ...
                              <p className="text-gray-700 text-sm">
                                {application.applicant.reasonForAdoption}
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="pt-4 border-t border-gray-100">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                              {application.applicant.references.map(
                                (ref, idx) => (
                                  <div
                                    key={idx}
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm font-medium text-gray-900">
                        ...
                        /{application.documents.length} Verified
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-500">References</span>
                      <span className="text-sm font-medium text-gray-900">
                        {application.applicant.references.length} Provided
                      </span>
                    </div>
                    <div className="flex justify-between">
