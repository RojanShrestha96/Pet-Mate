            ...
            {[
              {
                name: "Priya Sharma",
                quote:
                  "Knowing my donation helps feed and care for pets brings me so much joy.",
                amount: "Monthly Donor",
              },
              {
                name: "Rajesh Kumar",
                quote:
                  "I adopted my dog from PetMate. Now I donate to help other pets find homes.",
                amount: "NPR 5,000",
              },
              {
                name: "Sita Thapa",
                quote:
                  "Every rupee counts. I'm proud to support this amazing cause.",
                amount: "NPR 1,000",
              },
            ...
            {[
              {
                ...
                answer:
                  "Yes, PetMate is a registered non-profit organization. You will receive a receipt for tax purposes.",
              },
              {
                question: "How is my donation used?",
                answer:
                  "100% of donations go directly to pet care including food, medical treatment, vaccinations, and shelter maintenance.",
              },
              {
                question: "Can I donate monthly?",
                answer:
                  "Yes! Monthly donations help us plan better and provide consistent care. Contact us to set up recurring donations.",
              },
              {
                question: "Are donations secure?",
                answer:
                  "Absolutely. We use secure payment gateways (eSewa, Khalti) that encrypt your information.",
              },
            ].map((faq, index) => (
              <motion.div
                key={index}
